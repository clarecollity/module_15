...
def recommend_portfolio(intent_request):
    ...
    if source = "DialogCodeHook":
        ...
        validation = validate_data(intent_request, age, investment_amount)

        #If input is not valid, the dialog re-prompts the user 
        ...
        #if slots are valid, dialog is returned to Amazon Lex
